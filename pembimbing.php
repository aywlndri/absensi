	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Pembimbing</h3>
					<div class="table-responsive bs-example widget-shadow">
						<h4>Staff Pembimbing :</h4>
								<a href="addPembimbing.php"><button type="" class="btn btn-primary btn-flat btn-pri btn-xlg"><i class="fa fa-user-plus" aria-hidden="true"></i><font color="white"> Tambah Pembimbing</font></button></a>
							<br></br>						
						<table class="table table-bordered table-hover"> 
							...
							<?php
							$no = 1;
							$data = mysqli_query($koneksi, "SELECT * FROM user WHERE level='Pembimbing'");
							while($d = mysqli_fetch_array($data)){
							?>
								<th scope="row"><?php echo $no++; ?></th> 
									<td><?php echo $d['username']; ?></td> 
									<td>*****</td> 
									<td><?php echo $d['nimk']; ?></td> 
									<td><?php echo $d['namalengkap']; ?></td> 
									<td><?php echo $d['departement']; ?> </td> 
									<td><a href="hapusPembimbing.php?id=<?php echo $d['id_user']; ?>" onclick="return confirm('Hapus Pembimbing?');"><button type="button" class="btn btn-link btn-lg"><i class="fa fa-trash" ></i></button></a></td> 
							</tr> 
							<?php
							}
							?>
