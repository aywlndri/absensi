...
$cekdata = mysqli_fetch_array(mysqli_query($koneksi, "select * from user where username='$username'"));
	...
	{
		$query = "insert into user (username, password, id_pembimbing, level, departement, jabatan, notlppembimbing, pembimbing) values ('$username',MD5('$pass'), $id, 'Pemagang', '$dept', '$jab', '$no', '$nama_u')";
		mysqli_query($koneksi, $query);
		header('location: pemagang.php'); 
	}
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h2 class="title1">Tambah Pemagang</h2>
								...
								<form action="" method="POST" class="form-horizontal"> 
									...
									?>
										<div class="col-sm-offset-7">
											<button type="submit" name="konfirmasi" class="btn btn-success btn-flat btn-pri btn-md"><i class="fa fa-check" aria-hidden="true"></i> Simpan</button>
										</div> 
										<br>
								</form>
							</div>
