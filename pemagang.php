	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Pemagang</h3>
					<div class="table-responsive bs-example widget-shadow">
						<h4>Mahasiswa Pemagang :</h4>
							<a href="addPemagang.php"><button type="" class="btn btn-primary btn-flat btn-pri btn-xlg"><i class="fa fa-user-plus" aria-hidden="true"></i><font color="white"> Tambah Pemagang</font></button></a>
							<br></br>	
						<table class="table table-bordered table-hover"> 
							...
							<?php
							$no = 1;
							$data = mysqli_query($koneksi, "SELECT * FROM user WHERE id_pembimbing='$id'");
							...
							?>
								<th scope="row"><?php echo $no++; ?></th> 
									...
									<td><a href="hapusPemagang.php?id=<?php echo $d['id_user']; ?>" onclick="return confirm('Hapus Pemagang?');"><button type="button" class="btn btn-link btn-lg"><i class="fa fa-trash" ></i></button></a></td> 
							</tr>  
							<?php
							}
							?>
